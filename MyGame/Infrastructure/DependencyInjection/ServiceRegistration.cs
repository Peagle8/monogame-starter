...
public static class ServiceRegistration
{
    public static ServiceProvider Build(GameRoot gameRoot)
    {
        ...
        services.AddSingleton<IPlayerAbilityService>(_ => new PlayerAbilityService([PlayerAbility.Dash, PlayerAbility.Fireball, PlayerAbility.Missile, PlayerAbility.BombDash]));
        ...
        services.AddTransient<PlayerMissileTargetResolver>();
        ...
        services.AddTransient<PlayerDefenseAbilityController>();
        services.AddTransient<PlayerRangedAttackController>();
